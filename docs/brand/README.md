...
제품(안심 루프·유료 우선순위)은 **별축** → [docs/product/](../product/). 브랜드 단계 번호와 섞지 말 것.
...
각 단계: 읽을 문서 → 할 일 → **[gates.md](gates.md) 게이트 PASS** 후에만 다음 단계.

### 루프 (매 단계 공통)

1. [gates.md](gates.md) 해당 단계 목표·게이트 읽기  
2. **검토** — 게이트 항목별 PASS/FAIL  
3. FAIL만 **실행**  
4. 재검토 → 전부 PASS일 때만 다음 번호  
5. PASS 시 [impl.md](impl.md) 해당 행 `done`

상세 게이트 표·전체 성공 정의는 **gates.md가 SoT**. 아래는 요약.
...
| 끝 | [gates.md](gates.md) §2 — variant require 맵 동작. 빈자리 없음 |
...
| 끝 | [gates.md](gates.md) §3 — back / progress / 질문 타이틀 / 하단 CTA |
...
| 끝 | [gates.md](gates.md) §4 — 한 질문 한 스텝. 콕이 입구·완료만 |
...
| 끝 | [gates.md](gates.md) §5 — Lucide-only hero/empty 없음. 개별 체크 happy 없음 |
...
| 끝 | [gates.md](gates.md) §6 — 위 범위에서 약먹었약 0건 |
...
| 끝 | [gates.md](gates.md) §7 · [impl.md](impl.md) funnel-wave2 / beat-wave2 |

### 8. 보류

게이트: [gates.md](gates.md) §8 — 보류를 1·2차에 끌어오지 않음.  
...
목표·게이트·루프: [gates.md](gates.md) · 잠긴 결정: [decisions.md](decisions.md) · 체크리스트: [impl.md](impl.md)
