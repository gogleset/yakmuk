...
name: product-goals
description: >-
  yakmuk(약콕) 제품 목표·안심 구독 우선순위 문서(docs/goals/)를 읽고 따른다.
...
1. [docs/goals/README.md](../../../docs/goals/README.md) — 지도
2. [thesis.md](../../../docs/goals/thesis.md) — 가치·무료/유료
3. [goals.md](../../../docs/goals/goals.md) — **현재 단계**·게이트
4. [priorities.md](../../../docs/goals/priorities.md) · [decisions.md](../../../docs/goals/decisions.md)

다단계 구현 플랜이면 [.agents/rules/plan-with-gates.mdc](../../rules/plan-with-gates.mdc)도 적용.

## Rules

- goals **현재 단계** 게이트 PASS 전 다음 단계 착수 금지
...
- `docs/brand/goals.md` 단계 번호와 `docs/goals/goals.md` 번호를 섞기
