...
한 번에 1–2개. 전문가 톤이되 **용어 풀어쓰기**.

| 나쁜 예 | 좋은 예 |
|---------|---------|
| “Option A Notifee FSI vs B banner-only?” | “앱 밖에서도 화면 전체로 띄울까? Android만 가능하고 iOS는 알림 탭 후 앱 화면이야. Android도 풀스크린 갈까, 둘 다 탭 후 화면만 할까?” |
| “Edge stub scope?” | “서버 공지: 토큰만 DB에 저장할까, 테스트 발송용 Edge 함수까지 만들까?” |
