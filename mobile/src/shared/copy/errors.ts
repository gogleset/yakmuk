...
export const ERRORS = {
  ...
  invite: {
    ...
    invalidRole: '초대 역할이 올바르지 않아요',
    codeLength: `초대코드는 ${LIMITS.inviteCodeLength}자리예요`,
    limitReached: `초대는 최대 ${LIMITS.maxFamilyInvites}명까지예요`,
  },
